...
public class CapacitoresCircuitos extends JPanel {
	...
	public CapacitoresCircuitos() {
		...
		lblTitulo = new JLabel("Capacitancia Total");
		...
		JLabel lblNumeroCargaGeneral = new JLabel("# Capacitores");
		lblNumeroCargaGeneral.setBounds(31, 116, 97, 14);
		add(lblNumeroCargaGeneral);
		
		JLabel lblValorCarga = new JLabel("Valor Capacitancia:");
		...
		JLabel lblPotencial = new JLabel("Capacitancia Total:");
		...
		btnSetCarga = new JButton("Editar Capacitor");
